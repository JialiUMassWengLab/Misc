...
def main() -> None:
    ...
    parser.add_argument("--model", type=str, default="attention",
                        choices=["attention", "aa_pos_only"],
                        help="'attention': full-sequence attention-pooling + MLP. "
                             "'aa_pos_only': MLP over only the substitution-position "
                             "embedding row (much smaller/faster).")
    ...
    print(f"done. best val_auroc = {best_auroc:.4f}. log at {log_path}")
